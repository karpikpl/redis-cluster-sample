...
namespace RedisSample
{
    public static class GettingStarted
    {
        ...
        {
            return ConnectionMultiplexer.Connect(Helper.Configuration.Value["RedisCacheName"] + ",abortConnect=false,ssl=true,password=" + Helper.Configuration.Value["RedisCachePassword"], LogAnalyzer.Instance);
        });
